...
/// The callback used by [ReorderableList] to move an item to a new
/// position in a list.
///
...
/// [ReorderableList] will need to account for this when inserting before
/// [newIndex].
///
...
class ReorderableList extends StatefulWidget {
  ...
  /// underlying list.
  ///
  /// This [ReorderableList] calls [onReorder] after a list child is dropped
  /// into a new position.
...
class _ReorderableListContentState extends State<_ReorderableListContent>
  ...
  Widget _wrap(Widget toWrap, int index, BoxConstraints constraints) {
    ...
    Widget wrapWithSemantics() {
      ...
      if (index > 0) {
        semanticsActions[
                CustomSemanticsAction(label: localizations.reorderItemToStart.toString())] =
            moveToStart;
      ...
      if (index < widget.children.length - 1) {
        String reorderItemAfter = localizations.reorderItemDown.toString();
        if (widget.scrollDirection == Axis.horizontal) {
        ...
        semanticsActions[CustomSemanticsAction(label: localizations.reorderItemToEnd.toString())] =
            moveToEnd;
      }
